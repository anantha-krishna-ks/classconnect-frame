...
export default function ChapterManagement() {
  ...
  // Mock chapters data
  const chapters = [
    { id: 1, name: "Real Numbers", grade: "10", subject: "Mathematics" },
    { id: 2, name: "Polynomials", grade: "10", subject: "Mathematics" },
    { id: 3, name: "Chemical Reactions", grade: "10", subject: "Science" },
  ];
                    ...
                    <DialogContent className="max-w-2xl">
                      ...
                      <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                          ...
                          <Select>
                            <SelectTrigger id="chapter-school" className="bg-background">
                              <SelectValue placeholder="Choose school" />
                            </SelectTrigger>
                            <SelectContent className="bg-popover z-50">
                              <SelectItem value="1">Lincoln High School</SelectItem>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="grid gap-2">
                            ...
                            <Select>
                              <SelectTrigger id="chapter-grade" className="bg-background">
                          ...
                          <div className="grid gap-2">
                            ...
                            <Select>
                              <SelectTrigger id="chapter-subject" className="bg-background">
