...
const ResourceVault = () => {
  ...
  const [isStudyPalMinimized, setIsStudyPalMinimized] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Main Content Area */}
      <div className={showStudyPal && !isMobile ? "mr-[400px] transition-all duration-300" : ""}>
      ...
      {/* Desktop StudyPal - Fixed Right Panel */}
      {showStudyPal && !isMobile && (
        <div className={`fixed top-[180px] right-0 bottom-0 w-[400px] bg-white border-l border-slate-200 shadow-2xl transition-transform duration-300 z-40 ${
          isStudyPalMinimized ? 'translate-x-full' : 'translate-x-0'
        }`}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => setIsStudyPalMinimized(!isStudyPalMinimized)}
      ...
      {isMobile && (
        <Sheet open={showStudyPal} onOpenChange={setShowStudyPal}>
          <SheetContent side="bottom" className="h-[80vh] p-0 flex flex-col">
            ...
            {/* Chat Messages Area - Same content as desktop */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {chatHistory.length === 0 ? (
                <div className="h-full flex items-center justify-center">
                  <div className="text-center px-4">
      ...
      {/* Minimized StudyPal Button (Desktop) */}
      {showStudyPal && isStudyPalMinimized && !isMobile && (
        <Button
          onClick={() => setIsStudyPalMinimized(false)}
          className="fixed bottom-8 right-8 rounded-full w-14 h-14 bg-purple-500 hover:bg-purple-600 shadow-lg z-50"
          size="icon"
          title="Expand StudyPal"
        >
